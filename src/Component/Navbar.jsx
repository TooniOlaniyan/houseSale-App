        ...
        <nav className='navbarNav'>
            <ul className="navbarListItems">
                <li onClick={()=>{navigate('/')}} className='navbarListItem'>
                    ...
                    <p className={pathMatch('/') ? 'navbarListItem'  : 'navbarListItemName'} >Explore</p>
                </li>
                <li onClick={()=>{navigate('/offers')}} className='navbarListItem'>
                    <OfferIcon fill={pathMatch('/offers') ? '#2c2c2c' : '#8f8f8f'} width='36px' height= '36px'/>
                    <p className={pathMatch('/offers') ? 'navbarListItem'  : 'navbarListItemName'}>Offers</p>
                </li>
                <li onClick={()=>{navigate('/profile')}} className='navbarListItem'>
                    ...
                    <p className={pathMatch('/profile') ? 'navbarListItem'  : 'navbarListItemName'} >Profile</p>
                </li>
            </ul>
